table 78602 "BAC Translation Target"
{
  ...
  fields
  {
    ...
    field(20;"Trans-Unit Id";Text[2048])
    {
      DataClassification = AccountData;
    ...
    field(60;"Target";Text[2048])
    {
      ...
      trigger OnValidate()var Instances: Integer;
      ...
      begin
        ...
        if Instances > 1 then begin
          if CurrFieldNo > 0 then if not confirm(QuestionTxt)then exit;
          TransTarget.ModifyAll(Target, Target);
          TransTarget.ModifyAll(Translate, false);
        end;
        if Target <> '' then Translate:=false;
      end;
    }
    ...
    field(120;"Occurrencies";Integer)
    {
      ...
      CalcFormula = count("BAC Translation Target" where(Source=field(Source), "Project Code"=field("Project Code")));
    }
  }
  keys
  {
