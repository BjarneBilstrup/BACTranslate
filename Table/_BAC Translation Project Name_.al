table 78600 "BAC Translation Project Name"
{
    ...
    fields
    {
        ...
        field(60; "Xml Version"; Text[2048])
        {
            Caption = 'Xml Version';
            DataClassification = AccountData;
        }
        field(70; "Xliff Version"; Text[2048])
        {
            DataClassification = AccountData;
            Caption = 'Xliff Version';
        }
        field(80; "File Datatype"; Text[2048])
        {
            DataClassification = AccountData;
            Caption = 'File Datatype';
        }
        field(90; "File Name"; Text[2048])
        {
            DataClassification = SystemMetadata;
            Caption = 'File Name';
        }
    ...
    begin
        ...
        if "Project Code" = '' then begin
            ...
            if "Source Language" = '' then validate("Source Language", TransSetup."Default Source Language code");
        end;
    end;
    ...
    begin
        ...
        TransSetup.get;
        TransSetup.TestField("Project Nos.");
        if NoSeriesMgt.SelectSeries(TransSetup."Project Nos.", xRec."No. Series", TransProject."No. Series") then begin
            NoSeriesMgt.SetSeries(TransProject."Project Code");
            Rec := TransProject;
            exit(true);
        end;
    end;
