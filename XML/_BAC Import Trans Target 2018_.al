xmlport 78605 "BAC Import Trans Target 2018"
{
  ...
  {
  trigger OnAfterAssignVariable()begin
  ...
  {
  trigger OnAfterAssignVariable()var WrongSourceLangTxt: Label '%1 must be %2 in file - The file %1 is %3';
  begin
  ...
  inSourceLangISOCode: text[10];
  inTargetLangISOCode: Text[10])begin
